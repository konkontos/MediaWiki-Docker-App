<?php
    ...
    $wgSitename = "My Site Name";
    $wgMetaNamespace = "DEFAULT_NAMESPACE";
    ...
    $wgSecretKey = "[upgrade key setup by 1st wiki run]";
    ...
    $wgUpgradeKey = "[upgrade key setup by 1st wiki run]";
